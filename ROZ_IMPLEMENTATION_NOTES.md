...
| | Address | Verified |
|---|---|---|
| Game contract | `0x007030fb8aec5eb20ed893bb2147fefe0dd07b204d55be12fedf9ce4579f7a4f` | Answers `get_reward_token_pending`, so it is running this code |
...
sncast call --contract-address 0x03a5c876…5d445b --function balance_of \
  --arguments '0x007030fb…9f7a4f' --network sepolia     # -> 855000000000000000000000000
```
